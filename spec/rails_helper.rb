...
# OPENAPI=1 bundle exec rspec 実行時に doc/openapi.yaml を自動生成する
if defined?(RSpec::OpenAPI)
  RSpec::OpenAPI.title = "Tech Share API"
  RSpec::OpenAPI.path = Rails.root.join("doc/openapi.yaml").to_s
  RSpec::OpenAPI.application_version = "1.0.0"
  RSpec::OpenAPI.servers = [ { url: "http://localhost:3001", description: "Local development" } ]
  RSpec::OpenAPI.comment = <<~COMMENT
    This file is auto-generated by rspec-openapi from request specs.
